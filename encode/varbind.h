...
/*
 * Cria uma estrutura VarBind_t*, dependendo dos valores do object_syntax dado como argumento.
 ...
 * Preenche também os campos name e choice.value o object_name e object_syntax, respetivamente (caso o valor
