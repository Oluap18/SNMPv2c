...
static asn_oer_constraints_t asn_OER_type_VarBindList_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..2147483647)) */};
asn_per_constraints_t asn_PER_type_VarBindList_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 31, -1,  0,  2147483647 }	/* (SIZE(0..2147483647)) */,
...
asn_TYPE_descriptor_t asn_DEF_VarBindList = {
	...
	sizeof(asn_DEF_VarBindList_tags_1)
		/sizeof(asn_DEF_VarBindList_tags_1[0]), /* 1 */
	{ &asn_OER_type_VarBindList_constr_1, &asn_PER_type_VarBindList_constr_1, SEQUENCE_OF_constraint },
